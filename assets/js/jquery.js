            ...
            return (
                ...
                ((r = (T = n).documentElement),
                    ...
                    (le.getById = $(function(e) {
                        return (
                            (r.appendChild(e).id = ce.expando), !T.getElementsByName ||
    ...
    ce.extend({
            ...
            clone: function(e, t, n) {
                ...
                if (t)
                    if (n)
                        for (
                            o = o || Se(e), a = a || Se(c), r = 0, i = o.length; r < i; r++
                        )
                            Fe(o[r], a[r]);
                    else Fe(e, c);
                return (
            ...
            cleanData: function(e) {
                for (
                    var t, n, r, i = ce.event.special, o = 0; void 0 !== (n = e[o]); o++
                )
                    if ($(n)) {
                        if ((t = n[_.expando])) {
                            if (t.events)
        ...
        ce.each({
            ...
            function(e, a) {
                ce.fn[e] = function(e) {
                    for (
                        var t, n = [], r = ce(e), i = r.length - 1, o = 0; o <= i; o++
                    )
