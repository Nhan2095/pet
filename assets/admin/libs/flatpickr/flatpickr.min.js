/* flatpickr v4.6.13,, @license MIT */ !(function(e, n) {
                ...
                if (0 === e || e) {
                    ...
                    if (e instanceof Date) l = new Date(e.getTime());
                        ...
                        if ("today" === u)(l = new Date()), (i = !0);
                            ...
                            for (
                                var f = void 0, m = [], g = 0, p = 0, h = ""; g < d.length; g++
                            ) {
                                var w = d[g],
                                    b = "\\" === w,
                                    C = "\\" === d[g - 1] || b;
    ...
    function k(p, v) {
        ...
        function j(e, n) {
            ...
            n && w.currentYear !== a && (De("onYearChange"), q()), !n ||
        ...
        function J(e, n) {
            ...
            void 0 === i ?
                ...
                (function(e, n) {
                    for (
                        var t = -1 === e.className.indexOf("Month") ?
                            e.dateObj.getMonth() :
                            w.currentMonth,
                            a = n > 0 ? w.config.showMonths : -1,
                            i = n > 0 ? 1 : -1,
                            o = t - w.currentMonth; o != a; o += i
                    )
                        for (
                            var r = w.daysContainer.children[o],
                                ...
                                0,
                                c = r.children.length,
                                s = l; s >= 0 && s < c && s != (n > 0 ? c : -1); s += i
                        ) {
                            var d = r.children[s];
                            if (-1 === d.className.indexOf("hidden") &&
                                ne(d.dateObj) &&
        ...
        function K(e, n) {
            ...
            for (
                var f = i + 1; f <= 42 - t && (1 === w.config.showMonths || u % 7 != 0); f++, u++
            )
                o.appendChild(
        ...
        function U() {
            if (void 0 !== w.daysContainer) {
                ...
                for (
                    var e = document.createDocumentFragment(), n = 0; n < w.config.showMonths; n++
                ) {
            ...
            return function(n) {
                ...
                void 0 !== t &&
                    ...
                    (ue(),
                        ...
                        (w.currentYearElement.disabled = !!a &&
                            void 0 !== t &&
                ...
                if (void 0 !== w.calendarContainer) {
                    ...
                    if (
                        (s(w.calendarContainer, "arrowTop", !d),
                            s(w.calendarContainer, "arrowBottom", d), !w.config.inline)
                    ) {
                        ...
                        if (
                            ...
                            if (((w.calendarContainer.style.top = u + "px"), h))
                                if (v) {
                                    var D = (function() {
                                        for (
                                            var e = null, n = 0; n < document.styleSheets.length; n++
                                        ) {
        ...
        function fe() {
            w._input.focus(), -1 !== window.navigator.userAgent.indexOf("MSIE") ||
        ...
        (w.clear = function(e, n) {
            ...
            (w.selectedDates = []),
            (w.latestSelectedDateObj = void 0), !0 === n &&
        ...
        function ye(e) {
            void 0 === e && (e = !0),
                ...
                void 0 !== w.altInput &&
                (w.altInput.value = Me(w.config.altFormat)), !1 !== e && De("onValueUpdate");
        }
            ...
            (function() {
                ...
                (function() {
                    ...
                    t
                        ...
                        (w.isMobile = !w.config.disableMobile &&
                            !w.config.inline &&
                ...
                se(),
                    (function() {
                        ...
                        w.input.classList.add("flatpickr-input"),
                            ...
                            ((w.altInput = d(
                                ...
                                w.input.setAttribute("type", "hidden"), !w.config.static &&
                                w.input.parentNode &&
                    ...
                    (function() {
                        ...
                        if (
                            ((w.calendarContainer = d(
                                ...
                                (w.calendarContainer.tabIndex = -1), !w.config.noCalendar)
                        ) {
                            if (
                                (e.appendChild(
                                        ((w.monthNav = d(
                    ...
                    (function() {
                        w.config.wrap && ["open", "close", "toggle", "clear"].forEach(
                            function(e) {
                        ...
                        if (
                            ...
                            P(w.timeContainer, ["increment"], _),
                                ...
                                P(
                                    [w.hourElement, w.minuteElement], ["focus", "click"],
                                    n
                                ),
                                void 0 !== w.secondElement &&
